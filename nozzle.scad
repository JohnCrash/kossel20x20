...
module hot_block()
{
	difference()
	{
		translate([0,-5,0])cube([10,20,12],center=true);
		//加热棒安装孔
		translate([1,-9,-10])cylinder(r=3,h=20);
		translate([-2.5,-12,-10])cylinder(r=1.5,h=20,$fn=12);
		//挤出头安装孔
		translate([0,0,-10])cylinder(r=3,h=20);
		//安装螺丝
		translate([0,10,3])rotate([90,0,0])cylinder(r=1.25,h=8,$fn=12);
		translate([0,10,-3])rotate([90,0,0])cylinder(r=1.25,h=8,$fn=12);
		translate([1,-10,2])rotate([90,0,0])cylinder(r=1.25,h=8,$fn=12);
		translate([-2.5,-12,-2])rotate([90,0,0])cylinder(r=1.25,h=8,$fn=12);
	}
...
module nozzel()
{
	difference()
	{
		...
		translate([0,0,5])cylinder(r=2,h=6);
...
module nozzel_all()
{
	translate([0,0,-8])nozzel();
	hot_block();
	translate([0,0,8])nozzel_tube();
	//加热棒
